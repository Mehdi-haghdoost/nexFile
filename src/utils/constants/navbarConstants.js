...
export const NAVBAR_ICONS = {
  ...
  BLUE_LINE: (
    <svg xmlns="http://www.w3.org/2000/svg" width="2" height="40" viewBox="0 0 2 40" fill="none">
      <path d="M1 0L1 40" stroke="#4C3CC6" className="dark:stroke-white" strokeWidth="1.5" />
    </svg>
  ),
  LOGOUT: (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path 
        d="M7.5 17.5H4.16667C3.72464 17.5 3.30072 17.3244 2.98816 17.0118C2.67559 16.6993 2.5 16.2754 2.5 15.8333V4.16667C2.5 3.72464 2.67559 3.30072 2.98816 2.98816C3.30072 2.67559 3.72464 2.5 4.16667 2.5H7.5M13.3333 14.1667L17.5 10L13.3333 5.83333M17.5 10H7.5" 
        stroke="#737379" 
        strokeWidth="1.2" 
        strokeLinecap="round" 
        strokeLinejoin="round" 
...
export const NAVBAR_ITEMS = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
        <path d="M6.66667 14.6667H13.3333M9.18141 2.80333L3.52949 7.19927C3.15168 7.49312 2.96278 7.14005 2.82669 7.82405C2.70614 7.98704 2.61633 8.17065 2.56169 8.36588C2.5 8.58627 2.5 8.82558 2.5 9.30421V15.3333C2.5 16.2667 2.5 16.7335 2.68166 17.09C2.84144 17.4036 3.09641 17.6585 3.41002 17.8183C3.76654 18 4.23325 18 5.16667 18H14.8333C15.7668 18 16.2335 18 16.59 17.8183C16.9036 17.6585 17.1586 17.4036 17.3183 17.09C17.5 16.7335 17.5 16.2667 17.5 15.3333V9.30421C17.5 8.82558 17.5 8.58627 17.4383 8.36588C17.3837 8.17065 17.2939 7.98704 17.1733 7.82405C17.0372 7.64005 16.8483 7.49312 16.4705 7.19927L10.8186 2.80333C10.5258 2.57562 10.3794 2.46177 10.2178 2.418C10.0752 2.37938 9.92484 2.37938 9.78221 2.418C9.62057 2.46177 9.47418 2.57562 9.18141 2.80333Z" stroke="#737379" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  },
  {
