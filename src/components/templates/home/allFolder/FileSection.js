        ...
        return (
            <div className='flex flex-col items-center justify-center gap-4 flex-1 self-stretch p-12'>
                <svg 
                    ...
                    viewBox="0 0 64 64" 
                    fill="none"
                    className="stroke-[#9E9EA7] dark:stroke-white"
                >
                    <path 
                ...
                <div className='flex flex-col items-center gap-2'>
                    <h3 className='text-medium-18 dark:text-medium-18-white'>Select a folder</h3>
                    <p className='text-regular-14 dark:text-regular-14-white'>Choose a folder from the sidebar to view its files</p>
                </div>
            </div>
        );
    }
