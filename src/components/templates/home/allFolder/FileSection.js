    ...
    return (
        <>
            <div className='flex flex-col items-start gap-5 flex-1 w-full'>
                    ...
                    <div className='hidden md:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-full'>
                        {preparedFiles.map((file) => {
                            ...
                            return (
                                <div
                                    key={file.id}
                                    className='flex flex-col gap-3 p-4 rounded-lg border border-[#F2F2F3] dark:border-neutral-700 bg-white dark:bg-neutral-800 hover:border-primary-200 dark:hover:border-primary-500/30 transition-all group'
                                >
                                    {/* Checkbox & Menu */}
                                    ...
                                    <div className='flex items-center justify-center py-6'>
                                        {isFolder ? (
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 18 18" fill="none">
                                    ...
                                    {/* Name */}
                                    <h3 className='text-sm font-medium text-neutral-500 dark:text-white truncate text-center'>
                                        {displayName}
                                    </h3>
                ...
                {/* Mobile Card View (always list on mobile) */}
