...
const FileSection = () => {
    ...
    return (
        <div className='flex flex-col items-start gap-5 flex-1 w-full max-w-full overflow-x-hidden'>
            {/* File Header */}
            ...
            <div className='hidden md:flex flex-col w-full max-w-full rounded-lg border border-[#F2F2F3] dark:border-neutral-700 overflow-hidden'>
                <div className='w-full overflow-x-auto custom-scrollbar'>
                    {/* min-width برای tablet: 700px, برای desktop: 900px */}
                    <div className='min-w-[700px] xl:min-w-[900px]'>
                        <FileTableHeader
