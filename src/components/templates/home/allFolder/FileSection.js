                    ...
                    <div className='flex items-start gap-3'>
                        ...
                        <div className='flex justify-center items-center h-8 p-0.5 gap-1 bg-stroke-100 rounded-lg border border-[#ECECEE]'>
                            ...
                            <button className='flex justify-center items-center gap-1 py-[13px] px-[9px] self-stretch rounded-[5px]'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <path d="M2.33337 2.91671C2.33337 2.762 2.39483 2.61362 2.50423 2.50423C2.61362 2.39483 2.762 2.33337 2.91671 2.33337H5.25004C5.40475 2.33337 5.55312 2.39483 5.66252 2.50423C5.77192 2.61362 5.83337 2.762 5.83337 2.91671V5.25004C5.83337 5.40475 5.77192 5.55312 5.66252 5.66252C5.55312 5.77192 5.40475 5.83337 5.25004 5.83337H2.91671C2.762 5.83337 2.61362 5.77192 2.50423 5.66252C2.39483 5.55312 2.33337 5.40475 2.33337 5.25004V2.91671Z" stroke="#7A797F" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8.16671 2.91671C8.16671 2.762 8.22817 2.61362 8.33756 2.50423C8.44696 2.39483 8.59533 2.33337 8.75004 2.33337H11.0834C11.2381 2.33337 11.3865 2.39483 11.4959 2.50423C11.6053 2.61362 11.6667 2.762 11.6667 2.91671V5.25004C11.6667 5.40475 11.6053 5.55312 11.4959 5.66252C11.3865 5.77192 11.2381 5.83337 11.0834 5.83337H8.75004C8.59533 5.83337 8.44696 5.77192 8.33756 5.66252C8.22817 5.55312 8.16671 5.40475 8.16671 5.25004V2.91671Z" stroke="#7A797F" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M2.33337 8.75004C2.33337 8.59533 2.39483 8.44696 2.50423 8.33756C2.61362 8.22817 2.762 8.16671 2.91671 8.16671H5.25004C5.40475 8.16671 5.55312 8.22817 5.66252 8.33756C5.77192 8.44696 5.83337 8.59533 5.83337 8.75004V11.0834C5.83337 11.2381 5.77192 11.3865 5.66252 11.4959C5.55312 11.6053 5.40475 11.6667 5.25004 11.6667H2.91671C2.762 11.6667 2.61362 11.6053 2.50423 11.4959C2.39483 11.3865 2.33337 11.2381 2.33337 11.0834V8.75004Z" stroke="#7A797F" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8.16671 8.75004C8.16671 8.59533 8.22817 8.44696 8.33756 8.33756C8.44696 8.22817 8.59533 8.16671 8.75004 8.16671H11.0834C11.2381 8.16671 11.3865 8.22817 11.4959 8.33756C11.6053 8.44696 11.6667 8.59533 11.6667 8.75004V11.0834C11.6667 11.2381 11.6053 11.3865 11.4959 11.4959C11.3865 11.6053 11.2381 11.6667 11.0834 11.6667H8.75004C8.59533 11.6667 8.44696 11.6053 8.33756 11.4959C8.22817 11.3865 8.16671 11.2381 8.16671 11.0834V8.75004Z" stroke="#7A797F" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                        </div>
                    </div>
                    ...
                    <li className='flex items-center h-[52px] py-[13px] px-5 gap-2 self-stretch'>
                        ...
                        <ul className='flex items-center gap-3 flex-1'>
                            ...
                            <li className='flex items-center flex-1 py-0 px-3 gap-2'>
                                <img src="/images/adrian.png" alt="adrian" className='w-6 h-6 rounded-3xl' />
                                <h3 className='text-medium-14'>Adrian Carter</h3>
                            </li>
                            <li className='flex items-center w-[129px] py-0 px-3 gap-2 self-stretch'>
                                <h3 className='text-medium-14'>250 MB</h3>
                            </li>
                            <li className='flex items-center w-[171px] py-0 px-3 gap-2'>
                                <h3 className='text-medium-14'>05/08/2025</h3>
                            </li>
                    ...
                    <li className='flex items-center h-[52px] py-[13px] px-5 gap-2 self-stretch'>
                        ...
                        <ul className='flex items-center gap-3 flex-1'>
                            <li className='flex items-center w-[300px] h-10 py-0 px-3 gap-3'>
                                ...
                                <h3 className='text-medium-14'>Illustrator Design</h3>
                            </li>
                            <li className='flex items-center flex-1 py-0 px-3 gap-2'>
                                <img src="/images/bella.png" alt="bella" className='w-6 h-6 rounded-3xl' />
                                <h3 className='text-medium-14'>Bella Thompson</h3>
                            </li>
                            <li className='flex items-center w-[129px] py-0 px-3 gap-2 self-stretch'>
                                <h3 className='text-medium-14'>325 MB</h3>
                            </li>
                            <li className='flex items-center w-[171px] py-0 px-3 gap-2'>
                                <h3 className='text-medium-14'>22/12/2024</h3>
                            </li>
                            <li className='flex items-center justify-center w-[52px] py-0 px-3 gap-2'>
                                <div className='flex items-center p-1 gap-2.5 shadow-custom border border-[#F2F2F3] bg-white rounded'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="12" viewBox="0 0 4 12" fill="none">
                    ...
                    <li className='flex items-center h-[52px] py-[13px] px-5 gap-2 self-stretch'>
                        ...
                        <ul className='flex items-center gap-3 flex-1'>
                            <li className='flex items-center w-[300px] h-10 py-0 px-3 gap-3'>
                                ...
                                <h3 className='text-medium-14'>Canva Design</h3>
                            </li>
                            <li className='flex items-center flex-1 py-0 px-3 gap-2'>
                                <img src="/images/daniel.png" alt="daniel" className='w-6 h-6 rounded-3xl' />
                                <h3 className='text-medium-14'>Daniel Foster</h3>
                            </li>
                            <li className='flex items-center w-[129px] py-0 px-3 gap-2 self-stretch'>
                                <h3 className='text-medium-14'>340 MB</h3>
                            </li>
                            <li className='flex items-center w-[171px] py-0 px-3 gap-2'>
                                <h3 className='text-medium-14'>08/11/2024</h3>
                            </li>
                            <li className='flex items-center justify-center w-[52px] py-0 px-3 gap-2'>
                                <div className='flex items-center p-1 gap-2.5 shadow-custom border border-[#F2F2F3] bg-white rounded'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="12" viewBox="0 0 4 12" fill="none">
                    ...
                    <li className='flex items-center h-[52px] py-[13px] px-5 gap-2 self-stretch'>
                        ...
                        <ul className='flex items-center gap-3 flex-1'>
                            <li className='flex items-center w-[300px] h-10 py-0 px-3 gap-3'>
                                ...
                                <h3 className='text-medium-14'>Figma Design</h3>
                            </li>
                            <li className='flex items-center flex-1 py-0 px-3 gap-2'>
                                <img src="/images/emily.png" alt="emily" className='w-6 h-6 rounded-3xl' />
                                <h3 className='text-medium-14'>Emily Richardson</h3>
                            </li>
                            <li className='flex items-center w-[129px] py-0 px-3 gap-2 self-stretch'>
                                <h3 className='text-medium-14'>221 MB</h3>
                            </li>
                            <li className='flex items-center w-[171px] py-0 px-3 gap-2'>
                                <h3 className='text-medium-14'>30/09/2024</h3>
                            </li>
                            <li className='flex items-center justify-center w-[52px] py-0 px-3 gap-2'>
                                <div className='flex items-center p-1 gap-2.5 shadow-custom border border-[#F2F2F3] bg-white rounded'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="12" viewBox="0 0 4 12" fill="none">
                    ...
                    <li className='flex items-center h-[52px] py-[13px] px-5 gap-2 self-stretch'>
                        ...
                        <ul className='flex items-center gap-3 flex-1'>
                            <li className='flex items-center w-[300px] h-10 py-0 px-3 gap-3'>
                                ...
                                <h3 className='text-medium-14'>Canva Stock</h3>
                            </li>
                            <li className='flex items-center flex-1 py-0 px-3 gap-2'>
                                <img src="/images/adrian.png" alt="adrian" className='w-6 h-6 rounded-3xl' />
                                <h3 className='text-medium-14'>Samuel Hayes</h3>
                            </li>
                            <li className='flex items-center w-[129px] py-0 px-3 gap-2 self-stretch'>
                                <h3 className='text-medium-14'>992 MB</h3>
                            </li>
                            <li className='flex items-center w-[171px] py-0 px-3 gap-2'>
                                <h3 className='text-medium-14'>05/08/2024</h3>
                            </li>
                            <li className='flex items-center justify-center w-[52px] py-0 px-3 gap-2'>
                                <div className='flex items-center p-1 gap-2.5 shadow-custom border border-[#F2F2F3] bg-white rounded'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="12" viewBox="0 0 4 12" fill="none">
