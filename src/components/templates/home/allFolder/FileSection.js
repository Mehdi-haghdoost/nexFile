            ...
            <div className='flex flex-col items-start flex-1 self-stretch rounded-lg border border-[#F2F2F3]'>
                <div className='flex items-center h-10 py-[13px] px-5 gap-2 self-stretch bg-[#FCFCFC] border border-[#ECECEE]'>
                    ...
                    <ul className='flex flex-1 items-center gap-3 self-stretch'>
                        <li className='flex items-center w-[300px] h-[22px] py-0 px-3 gap-2'>
                        ...
                        <li className='flex justify-between items-start w-13 py-0 px-3 self-stretch'>
                ...
                <ul className='w-full'>
                    <li className='flex items-center h-[52px] py-[13px] px-5 gap-2  self-stretch'>
                        ...
                        <ul className='flex items-center gap-3 flex-1'>
                            ...
                            <li className='flex items-center justify-center w-13 py-0 px-3 gap-2 '>
                                <div className='flex items-center p-1 gap2.5 boxShadow-middle border border-[#F2F2F3] bg-white roundedّ'>
