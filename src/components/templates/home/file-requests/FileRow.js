...
import FileRequestActionMenu from '@/components/modules/home/file-requests/FileRequestActionMenu';

const FileRow = memo(({ file, onToggleStatus, onDelete }) => (
  <>
    {/* Desktop view (>= 1024px) */}
    <div className='hidden lg:flex items-center gap-3 px-3 py-3 self-stretch border-b border-stroke-200 dark:border-neutral-700 last:border-b-0 hover:bg-gray-50/50 dark:hover:bg-neutral-800/50 transition-colors group'>
      <div className='flex flex-1 items-center gap-3 min-w-0'>
        ...
        <div className='flex justify-between items-center w-[52px] py-0 px-3 self-stretch flex-shrink-0'>
          <FileRequestActionMenu file={file} onToggleStatus={onToggleStatus} onDelete={onDelete} />
        </div>
      </div>
    </div>
