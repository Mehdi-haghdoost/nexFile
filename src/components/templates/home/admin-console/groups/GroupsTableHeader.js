        ...
        <header className='hidden md:flex items-center gap-2 min-h-[40px] py-3 px-4 self-stretch border-b border-stroke-300 bg-stroke-50 dark:bg-neutral-800 dark:border-neutral-700'>
            <div className='flex flex-1 items-center gap-3 min-w-0'>
                ...
                <div className='flex flex-1 items-center gap-2 min-h-[22px] py-0 px-3 min-w-0'>
                    <h3 className='text-sm text-neutral-300 dark:text-neutral-300'>Group name</h3>
                </div>
                
                {/* Members Header */}
                <div className='flex flex-1 items-center gap-2 py-0 px-3 self-stretch flex-shrink-0'>
                    <h3 className='text-sm text-neutral-300 dark:text-neutral-300'>Members</h3>
                </div>
                
                {/* Managers Header */}
                <div className='flex flex-1 items-center gap-2 py-0 px-3 self-stretch flex-shrink-0'>
                    <h3 className='text-sm text-neutral-300 dark:text-neutral-300'>Managers</h3>
                </div>
