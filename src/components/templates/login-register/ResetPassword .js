...
const ResetPassword = () => {
  return (
    <div className={`${styles.resetPassword}  flex-col items-center dark:bg-gray-900 shrink-0 h-full rounded-xl bg-white shadow-sm mx-3`}>
              ...
              <div className='resetPasswordForm_body flex flex-col items-center gap-6 self-stretch'>
                <div className='resetPasswordForm_input flex flex-col  gap-4 self-stretch'>
                  <div className='resetPasswordForm_input_fields flex flex-col items-center gap-3'>
                    ...
                    <div className='loginForm_input_textfield flex flex-col items-center justify-center self-stretch gap-1 self-stretch  '>
                      <h3 className='self-stretch text-regular-12-neutral-300'>Confirm Password</h3>
                      <div className='.loginForm_input_inner flex items-center justify-center w-full h-[48px] py-3 px-4 gap-2 rounded-lg border border-stroke-500 bg-white resetPasswordForm_input_inner flex items-center justify-center w-full h-[48px] py-3 px-4 gap-2 rounded-lg border border-stroke-500 bg-white dark:bg-neutral-800 dark:border-neutral-600'>
                          <input
                          type="Password"
                          className='input-styled placeholder-regular-14 dark:placeholder-regular-14-white outline-0 bg-transparent dark:text-white outline-0'
                          placeholder='••••••••'
