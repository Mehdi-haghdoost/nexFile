...
//   return (
//     <div className={`flex flex-col items-center dark:bg-gray-900 shrink-0 h-full dark:bg-gray-900 dark:bg-neutral-900 rounded-xl bg-white shadow-sm mx-3 pt-[80px]`}>
//       <div className='h-full'>
//         <div className='w-[350px] h-[699px]'>
//           <div className='login_container flex w-[350px] flex-col items-center gap-10'>
//             <div className='login_logo_container flex items-center justify-center gap-3'>
...
//               <div className='loginForm_header flex flex-col text-center items-center justify-center gap-2'>
...
//                 </div>
//                 <h3 className='text-regular-14 w-[292px]'>Enter your username and password to Login</h3>
//               </div>

//               <div className='loginForm_body flex flex-col items-center gap-6 self-stretch'>
...
//                         />
//                         <label htmlFor="remember-checkbox" className="text-regular-14">Remember me</label>
//                       </div>
//                     </div>
//                     <button
//                       type="button"
//                       onClick={() => goto('forget')}
//                       className='text-regular-12-primary hover:underline'
//                     >
//                       Forgot password?
//                     </button>
//                   </div>
...
//                     <button
//                       type="button"
//                       className='flex h-[48px] py-3 pr-4 pl-3 justify-center items-center gap-2 flex-1 rounded-lg border border-stroke-500 bg-white dark:border-neutral-600 dark:bg-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-700 transition-colors'
//                     >
...
//                       </svg>
//                       <span className='text-regular-14-neutral-500 dark:text-regular-14-white'>Google</span>
//                     </button>
...
//                       </svg>
//                       <span className='text-regular-14-neutral-500 dark:text-regular-14-white'>Apple</span>
//                     </button>
//                   </div>
//                 </div>
//               </div>
...
const Login = ({ goto }) => {
  ...
  return (
    <div className={`${styles.login} flex flex-col items-center dark:bg-neutral-900 min-h-screen md:min-h-full md:h-auto md:rounded-xl bg-white md:shadow-sm md:mx-3 overflow-x-hidden`}>
        ...
        <div className='w-full max-w-[350px] flex flex-col gap-6 md:gap-8'>
          ...
          <form onSubmit={handleLogin} className='flex flex-col items-center gap-6 w-full'>
            ...
            <div className='flex flex-col gap-4 w-full'>
              ...
              <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 w-full'>
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="remember-checkbox" className="text-sm text-neutral-300 dark:text-neutral-200">
                    Remember me
                  </label>
                </div>
                <button
            ...
            <div className='flex flex-col sm:flex-row items-center gap-3 w-full'>
              <button
                type="button"
                className='flex h-12 w-full sm:flex-1 py-3 px-4 justify-center items-center gap-2 rounded-lg border border-stroke-500 bg-white dark:border-neutral-600 dark:bg-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-700 transition-colors'
              >
                <svg className='shrink-0' xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                  <path d="M17.1258 9.17493C17.1258 8.52743 17.0722 8.05493 16.9561 7.56494H9.4115V10.4874H13.84C13.7508 11.2137 13.2686 12.3074 12.1972 13.0424L12.1822 13.1402L14.5676 14.9513L14.7329 14.9674C16.2507 13.5937 17.1258 11.5724 17.1258 9.17493Z" fill="#4285F4" />
                  <path d="M9.41098 16.875C11.5806 16.875 13.402 16.175 14.7324 14.9675L12.1967 13.0424C11.5181 13.5062 10.6074 13.8299 9.41098 13.8299C7.28601 13.8299 5.48246 12.4562 4.83954 10.5574L4.7453 10.5653L2.26486 12.4465L2.23242 12.5349C3.55383 15.1074 6.26811 16.875 9.41098 16.875Z" fill="#34A853" />
                  <path d="M4.84004 10.5575C4.6704 10.0675 4.57223 9.54245 4.57223 8.99997C4.57223 8.45744 4.6704 7.93246 4.83112 7.44247L4.82662 7.33811L2.31509 5.42664L2.23291 5.46494C1.6883 6.53245 1.37579 7.73123 1.37579 8.99997C1.37579 10.2687 1.6883 11.4674 2.23291 12.5349L4.84004 10.5575Z" fill="#FBBC05" />
                  <path d="M9.41103 4.16998C10.9199 4.16998 11.9378 4.80873 12.5182 5.34251L14.786 3.1725C13.3932 1.90375 11.5806 1.125 9.41103 1.125C6.26814 1.125 3.55384 2.89249 2.23242 5.46497L4.83063 7.44249C5.48248 5.54375 7.28604 4.16998 9.41103 4.16998Z" fill="#EB4335" />
