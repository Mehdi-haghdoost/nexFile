...
const Login = ({ goto }) => {
  ...
  const handleLogin = (e) => {
    ...
    // اینجا می‌تونید validation و API call اضافه کنید
    if (email && password) {
      // ذخیره اطلاعات لاگین در localStorage یا store
      ...
      <div className={styles.login_shape}>
        <div className='login_container flex flex-col w-[350px] items-center gap-12'>
          ...
          <div className='loginForm_container flex flex-col items-center gap-12 self-stretch'>
            ...
            <form onSubmit={handleLogin} className='loginFrom_body flex flex-col items-center gap-6 self-stretch'>
              <div className='loginForm_input flex flex-col gap-4 self-stretch'>
                <div className='loginForm_input_fields flex flex-col items-center gap-3'>
                  ...
                  <div className='loginForm_input_textfield flex flex-col items-center justify-center self-stretch gap-1'>
