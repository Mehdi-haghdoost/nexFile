...
const PROGRESS_TRACK_WIDTH = 187;
...
const StorageWidget = ({ onUpgradeClick }) => {
  ...
  // Only fetch when the store is empty; the panel may have loaded it already
  useEffect(() => {
  ...
  const filledWidth = (percentage / 100) * PROGRESS_TRACK_WIDTH;
