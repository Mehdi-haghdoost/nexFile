...
const Navbar = () => {
  ...
  const renderNavItem = (item) => (
    ...
    >
      ...
      {hoveredItem === item.id && (
        <div className="absolute left-full top-1/2 -translate-y-1/2 ml-2 z-[70] pointer-events-none bubble-tooltip-container bubble-tooltip-float">
