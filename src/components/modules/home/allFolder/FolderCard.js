...
const FolderCard = ({ folderName, onMenuClick }) => {
    ...
    return (
        <div className='flex w-full h-[36px] sm:h-[38px] py-1 px-2 sm:px-3 items-center gap-1.5 sm:gap-2 self-stretch rounded-lg border border-[#ECECEE] bg-[#FCFCFC] dark:bg-neutral-800 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-700 transition-colors'>
            {/* Folder Icon */}
