...
const FileSectionHeader = () => {
    ...
    return (
        <div className='flex flex-col items-start gap-3 self-stretch w-full'>
            ...
            {/* Actions Section - Two Rows for Mobile/Tablet (< md), Single Row for Desktop (>= md) */}
            <div className='flex flex-col md:flex-row md:justify-between md:items-center gap-2 md:gap-3 self-stretch w-full'>
                
                {/* Recent & Starred (always together) */}
                <div className='flex items-center gap-2 md:gap-3'>
                    <button className='flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 whitespace-nowrap shadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-dark-border dark:bg-dark-gradient dark:shadow-dark-panel'>
                        ...
                        <h3 className='text-sm font-medium dark:text-white'>Recent</h3>
                    </button>
                    <button className='flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 whitespace-nowrap shadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-dark-border dark:bg-dark-gradient dark:shadow-dark-panel'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0">
                        ...
                        <h3 className='text-sm font-medium dark:text-white'>Starred</h3>
                    </button>
                </div>
                ...
                <div className='flex items-center gap-2 md:gap-3'>
                    ...
                    <button className='hidden sm:flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 shadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-dark-border dark:bg-dark-gradient dark:shadow-dark-panel whitespace-nowrap'>
                        ...
                        <h3 className='text-sm font-medium dark:text-white'>Filter</h3>
                    </button>
                    ...
                    <div className='flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 shadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-neutral-700 dark:bg-neutral-900 flex-1 md:min-w-[180px]'>
                        ...
                        <input 
                            type="text" 
                            className='text-xs font-normal dark:text-white dark:bg-neutral-900 flex-1 outline-0 min-w-0' 
                            placeholder='Search...' 
                        />
                    </div>
                    ...
                    <div className='flex justify-center items-center h-8 p-0.5 gap-1 bg-stroke-100 rounded-lg border border-[#ECECEE] dark:bg-neutral-900 dark:border-neutral-700 shrink-0'>
                        <button 
                            ...
                            className={`flex py-[13px] px-[9px] justify-center items-center gap-1.5 self-stretch rounded-lg border transition-[border,box-shadow,transform,color,opacity]
                                ${viewMode === 'list' 
                        ...
                        <button 
                            ...
                            className={`flex justify-center items-center gap-1 py-[13px] px-[9px] self-stretch rounded-[5px] border transition-[border,box-shadow,transform,color,opacity]
                                ${viewMode === 'grid' 
                                    ? 'shadow-middle bg-white border-[#F2F2F3] dark:border-dark-border dark:shadow-dark-panel dark:bg-dark-gradient' 
                                    : 'bg-transparent border-transparent dark:bg-transparent dark:border-transparent'
                                }`}
