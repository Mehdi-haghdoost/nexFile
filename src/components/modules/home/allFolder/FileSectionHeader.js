        ...
        <div className='flex flex-col items-start gap-3 self-stretch'>
            <div className='flex justify-between items-center self-stretch'>
                {selectedFolder ? (
                    <div className='flex items-center gap-2'>
                        <h2 className='text-medium-18 dark:text-medium-18-white'>{selectedFolder.name}</h2>
                    </div>
                ) : (
                    <h2 className='text-medium-18 dark:text-medium-18-white'>Your file</h2>
                )}
                <div className='flex items-center -gap-1'>
                    <img src="/images/adrian.png" className='dark:bg-neutral-600' alt="adrian" />
            ...
            <div className='flex justify-between items-center self-stretch'>
                <div className='flex items-start gap-3'>
                    <button className='flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 boxShadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-dark-border dark:bg-dark-gradient dark:shadow-dark-pane'>
                ...
                <div className='flex items-start gap-3'>
                    <button className='flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 boxShadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-dark-border dark:bg-dark-gradient dark:shadow-dark-pane'>
                        ...
                        <h3 className='text-medium-14  dark:text-medium-14-white text-center'>Filter</h3>
                    </button>
                    <button className='flex h-8 w-45 py-4 pr-4 pl-3 justify-center items-center gap-1.5 boxShadow-light bg-white rounded-lg border border-[#ECECEE] dark:border-neutral-700 dark:bg-neutral-900'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        <input type="text" className='text-regular-12-manrope dark:text-regular-12-manrope-white dark:bg-neutral-900 flex-1 outline-0' placeholder='Search...' />
                    </button>
                    <div className='flex justify-center items-center h-8 p-0.5 gap-1 bg-stroke-100 rounded-lg border border-[#ECECEE] dark:bg-neutral-900 dark:border-neutral-700'>
                        <button 
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                <path d="M2.33337 2.91671C2.33337 2.762 2.39483 2.61362 2.50423 2.50423C2.61362 2.39483 2.762 2.33337 2.91671 2.33337H5.25004C5.40475 2.33337 5.55312 2.39483 5.66252 2.50423C5.77192 2.61362 5.83337 2.762 5.83337 2.91671V5.25004C5.83337 5.40475 5.77192 5.55312 5.66252 5.66252C5.55312 5.77192 5.40475 5.83337 5.25004 5.83337H2.91671C2.762 5.83337 2.61362 5.77192 2.50423 5.66252C2.39483 5.55312 2.33337 5.40475 2.33337 5.25004V2.91671Z" stroke="#7A797F" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className={viewMode === 'grid' ? 'dark:stroke-white' : ''} />
                                <path d="M8.16671 2.91671C8.16671 2.762 8.22817 2.61362 8.33756 2.50423C8.44696 2.39483 8.59533 2.33337 8.75004 2.33337H11.0834C11.2381 2.33337 11.3865 2.39483 11.4959 2.50423C11.6053 2.61362 11.6667 2.762 11.6667 2.91671V5.25004C11.6667 5.40475 11.6053 5.55312 11.4959 5.66252C11.3865 5.77192 11.2381 5.83337 11.0834 5.83337H8.75004C8.59533 5.83337 8.44696 5.77192 8.33756 5.66252C8.22817 5.55312 8.16671 5.40475 8.16671 5.25004V2.91671Z" stroke="#7A797F" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className={viewMode === 'grid' ? 'dark:stroke-white' : ''} />
                                <path d="M2.33337 8.75004C2.33337 8.59533 2.39483 8.44696 2.50423 8.33756C2.61362 8.22817 2.762 8.16671 2.91671 8.16671H5.25004C5.40475 8.16671 5.55312 8.22817 5.66252 8.33756C5.77192 8.44696 5.83337 8.59533 5.83337 8.75004V11.0834C5.83337 11.2381 5.77192 11.3865 5.66252 11.4959C5.55312 11.6053 5.40475 11.6667 5.25004 11.6667H2.91671C2.762 11.6667 2.61362 11.6053 2.50423 11.4959C2.39483 11.3865 2.33337 11.2381 2.33337 11.0834V8.75004Z" stroke="#7A797F" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className={viewMode === 'grid' ? 'dark:stroke-white' : ''} />
                                <path d="M8.16671 8.75004C8.16671 8.59533 8.22817 8.44696 8.33756 8.33756C8.44696 8.22817 8.59533 8.16671 8.75004 8.16671H11.0834C11.2381 8.16671 11.3865 8.22817 11.4959 8.33756C11.6053 8.44696 11.6667 8.59533 11.6667 8.75004V11.0834C11.6667 11.2381 11.6053 11.3865 11.4959 11.4959C11.3865 11.6053 11.2381 11.6667 11.0834 11.6667H8.75004C8.59533 11.6667 8.44696 11.6053 8.33756 11.4959C8.22817 11.3865 8.16671 11.2381 8.16671 11.0834V8.75004Z" stroke="#7A797F" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className={viewMode === 'grid' ? 'dark:stroke-white' : ''} />
                            </svg>
                        </button>
                    </div>
                </div>
