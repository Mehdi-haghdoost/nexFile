...
//                 {/* ✅ Recent & Starred - Independent Toggle */}
//                 <div className='flex items-center gap-2 md:gap-3'>
//                     <button 
//                         onClick={toggleRecent}
//                         className={`flex h-8 py-4 pr-4 pl-3 justify-center items-center gap-1.5 whitespace-nowrap shadow-light rounded-lg border transition-all ${
//                             showRecent
...
//                                 stroke={showRecent ? '#4C3CC6' : '#2E2E37'}
//                                 strokeWidth="1.2" 
//                                 strokeLinecap="round" 
...
//                             className={`flex py-[13px] px-[9px] justify-center items-center gap-1.5 self-stretch rounded-lg border transition-all
//                                 ${viewMode === 'list' 
...
//                             className={`flex justify-center items-center gap-1 py-[13px] px-[9px] self-stretch rounded-[5px] border transition-all
//                                 ${viewMode === 'grid' 
//                                     ? 'shadow-middle bg-white border-[#F2F2F3] dark:border-dark-border dark:shadow-dark-panel dark:bg-dark-gradient' 
//                                     : 'bg-transparent border-transparent'
//                                 }`}
...
const FileSectionHeader = () => {
    ...
    const selectedFolder = getSelectedFolderData();
    const { showRecent, showStarred, toggleRecent, toggleStarred } = useFilterStore();
    const { searchQuery, setSearchQuery } = useSearchStore(); // ✅ Add search
    const [viewMode, setViewMode] = useState('list');
