...
const SecurityActionButton = () => {
    return (
        <button
            className="flex items-center justify-center w-8 h-8 p-1 gap-2.5 shadow-custom border border-stroke-200 bg-white rounded cursor-pointer hover:bg-gray-50 transition-colors dark:bg-dark-gradient dark:border-dark-border"
