        ...
        <article className='flex flex-col rounded-lg bg-white border border-stroke-300 min-w-0'>
            ...
            <div className='flex flex-col gap-5 p-4'>
                ...
                <div className='flex items-center gap-2'>
                    <div className='h-[10px] flex-1 rounded-[4.722px] bg-[#EDECF9] relative overflow-hidden'>
                        {percentage > 0 && (
                            <div
            ...
            <footer className='flex flex-wrap justify-between items-center py-3 px-4 gap-2 border-t border-stroke-300'>
                ...
                <button
                    ...
                    className='flex justify-center items-center gap-1.5 py-[13px] px-3 h-8 rounded-lg border border-stroke-300 shadow-light bg-white text-medium-14 text-sm whitespace-nowrap hover:bg-[#F6F6F7] transition-colors'
                >
                    Manage storage
                </button>
            </footer>
