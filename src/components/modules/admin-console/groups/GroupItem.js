...
const GroupItem = ({ group, onUpdateGroup, onDeleteGroup }) => {
    return (
        <>
            ...
            <li className='hidden md:flex items-center gap-3 px-3 py-3 self-stretch border-b border-stroke-300 dark:border-neutral-700 last:border-b-0 hover:bg-gray-50 dark:hover:bg-neutral-800/50 transition-colors group'>
                <div className='flex flex-1 items-center gap-3 min-w-0'>
                    ...
                    <div className='flex flex-1 items-center gap-3 py-0 px-3 self-stretch flex-shrink-0'>
                        <p className='text-sm text-neutral-300 dark:text-neutral-300 group-hover:text-gray-900 dark:group-hover:text-gray-200 transition-colors'>
                            {group.membersCount} {group.membersCount === 1 ? 'person' : 'people'}
                        </p>
                    </div>
                    ...
                    <div className='flex flex-1 items-center gap-2 py-0 px-3 self-stretch flex-shrink-0'>
                        <img
                            ...
                            src={group.manager.avatar || DEFAULT_AVATAR}
                    ...
                    <div className='flex justify-center items-center gap-2 w-[52px] py-0 px-3 flex-shrink-0'>
                        <GroupActionMenu group={group} onUpdateGroup={onUpdateGroup} onDeleteGroup={onDeleteGroup} />
                    </div>
                </div>
            </li>
