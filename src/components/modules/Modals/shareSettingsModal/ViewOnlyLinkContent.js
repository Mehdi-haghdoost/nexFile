        ...
        <div className='flex flex-col items-start gap-4 self-stretch overflow-hidden px-1'>
                    ...
                    {isExpirationEnabled && (
                        <>
                            <button
                                ...
                                className='flex items-center w-[160px] h-8 pl-3 pr-4 gap-2 rounded-lg border border-[#ECECEE] dark:border-neutral-700 shadow-light dark:shadow-dark-panel bg-white dark:bg-neutral-800'
                            >
                                <CalendarDateIcon />
                                <h3 className='text-medium-14 dark:text-medium-14-white flex-1 text-start'>{new Date(expirationDate).toLocaleDateString('en-US')}</h3>
                            </button>
                            <input
                                type="date"
                                ref={dateInputRef}
            ...
            <div className='flex items-center justify-between self-stretch'>
                <div className='flex flex-1 flex-col items-center justify-center gap-0.5 '>
                    ...
                    <p className='text-regular-12-neutral-200 dark:text-regular-12-white self-stretch'>Create a password to control access to
                        <br />
                ...
                <div className='flex flex-col items-end justify-center gap-3'>
                    ...
                    {isPasswordEnabled && (
                        <div className='flex items-center w-[160px] h-8 px-3 gap-2 rounded-lg border border-[#ECECEE] dark:border-neutral-700 shadow-light dark:shadow-dark-panel bg-white dark:bg-neutral-800'>
                            ...
                            />
                            <button onClick={() => setIsPasswordVisible(!isPasswordVisible)} className="flex-shrink-0 text-gray-500 dark:text-neutral-400 hover:text-gray-800 dark:hover:text-neutral-200 transition-colors">
            ...
            <div className='flex items-center justify-between self-stretch'>
                <div className='flex flex-1 flex-col items-center justify-center gap-0.5 '>
                    ...
                    <p className='text-regular-12-neutral-200 dark:text-regular-12-white self-stretch'>To turn off download capabilities, distribute
                        <br />
