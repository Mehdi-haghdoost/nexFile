...
const CreateSignatureModal = () => {
    ...
    const getSignatureData = () => {
        switch (activeTab) {
            ...
            case 'type':
                return typeRef.current?.getTypeData();
            case 'upload':
                return uploadRef.current?.getUploadData();
            default:
                return null;
        }
    };
    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'draw':
                return <DrawContent ref={drawRef} />;
            case 'type':
                return <TypeContent ref={typeRef} />;
            case 'upload':
                return <UploadContent ref={uploadRef} />;
            case 'saved':
                return <SavedContent onClose={handleClose} />;
            default:
                return <DrawContent ref={drawRef} />;
        }
    };
