...
const CreateTransferModal = () => {
    ...
    return (
        <BaseModal isOpen={isOpen} onClose={handleClose} width='520px'>
            <div className="w-full">
                ...
                <div className='flex justify-between items-center self-stretch mb-6'>
                    <h2 className='text-medium-18 dark:text-medium-18-white'>
                            ...
                            <div className='flex flex-col items-center gap-6 self-stretch '>
                                <div
                                    ...
                                    className={`
                                        ...
                                        py-12 px-6 rounded-lg border-2 border-dashed transition-all duration-200 dark:bg-neutral-900 dark:border-neutral-700
                                        ${isDragging
                                    ...
                                    `}
                                >
                                    <div className="rounded-lg bg-gradient-to-t from-[#9B9B9E] to-[#CDCDD1] shadow-[inset_0_-1px_1px_0_rgba(0,0,0,0.08),inset_0_1px_1px_0_rgba(255,255,255,0.40)] flex w-8 h-8 p-1 justify-center items-center gap-2 flex-shrink-0 aspect-square dark:bg-dark-neutral-gradient dark:border-dark-white-70">
                                    ...
                                    <p className='text-regular-14 text-neutral-400 text-center dark:text-regular-14-white'>
                                        Drag and drop files here to upload
                                    </p>
                                </div>

                                <label className='flex justify-center items-center gap-1.5 h-10 py-3 px-6 rounded-lg border border-stroke-300 bg-white shadow-light text-medium-14 dark:text-medium-14-white cursor-pointer transition-all duration-200 hover:shadow-md hover:scale-105 active:scale-95 dark:bg-dark-gradient dark:border-dark-border'>
                                    <UploadIcon />
                                    <input
                                        type="file"
                                        multiple
                            ...
                            <div className='flex flex-col gap-6'>
                                ...
                                >
                                    <div className='flex justify-between items-center w-full'>
                                        {/* Link/Email Tabs */}
                                        <div className='flex items-center h-8 gap-1 p-0.5 rounded-lg border border-stroke-300 bg-stroke-100 dark:bg-neutral-900 dark:border-neutral-700'>
                                            <button
        ...
        `}
                                        ...
                                        <label className='flex justify-center items-center gap-1.5 h-8 py-2 px-4 rounded-lg border border-stroke-300 bg-white shadow-light text-medium-14 dark:text-medium-14-white cursor-pointer transition-all duration-200 hover:border-gray-400 hover:shadow-md active:scale-95 dark:bg-dark-gradient dark:border-dark-border'>
                                            <UploadIcon />
                                            <input
                                                type="file"
                                                multiple
                                    ...
                                    {/* Files Count */}
                                    <p className='text-medium-14 dark:text-medium-14-neutral-400'>
                                    ...
                                    <div className={`
                                        ...
                                        {files.map((file) => (
                                            <div
                                                key={file.id}
                                                className='flex justify-between items-center p-3 rounded-lg border border-stroke-200 bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700'
                                            >
                                                <div className='flex items-center gap-2 self-stretch '>
                                                    <FileIcon extension={file.extension} />
                                                    <div className='flex flex-col gap-1'>
                                                        <p className='text-medium-14 text-gray-900 dark:text-medium-14-white'>{file.name}</p>
                                                        <p className='text-regular-12 text-gray-500 dark:text-regular-12-neutral-300'>{file.size}</p>
                                                    </div>
                                                </div>
                                                <button
