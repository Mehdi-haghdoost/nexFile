      ...
      <div>
        ...
        <div className='relative'>
          <input
            ...
            className='w-full h-10 px-3 py-2 pr-10 text-sm border border-gray-300 dark:bg-neutral-700 dark:border-neutral-600 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent'
          />
          <button
            type="button"
        ...
        {showStrength && password && (
          <div className='mt-2'>
            <div className='flex items-center gap-2'>
              <div className='flex-1 bg-gray-200 dark:bg-neutral-600 rounded-full h-1'>
                <div 
      ...
      <div>
        ...
        <div className='relative'>
          <input
            ...
            className={`w-full h-10 px-3 py-2 pr-10 text-sm border rounded-lg dark:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
              passwordsDontMatch ? 'border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-500' : 
              passwordsMatch === true ? 'border-green-300 bg-green-50 dark:bg-green-900/20 dark:border-green-500' : 'border-gray-300 dark:border-neutral-600'
            } dark:text-white`}
          />
          <button
            type="button"
